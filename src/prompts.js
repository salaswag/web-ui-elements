...
// ── Batch: fill the thin categories (Journey/Timeline, Device Mockup,
//    Motion/Device, Photo/Gallery). All live, self-contained ext effects. ──────
demos.push(
  // ----- Journey / Timeline -----
  { id: 'ext-vertical-timeline', num: '↗', source: 'external', live: true, ext: 'vertical-timeline', route: '/x/vertical-timeline',
    title: 'Vertical Timeline', author: 'Codrops pattern',
    blurb: 'Alternating left/right entries reveal as they enter the viewport, dots popping along a center rail.',
    complexity: 'easy', platform: 'any', categories: ['Journey / Timeline', 'Scroll-driven'],
    library: 'IntersectionObserver (no deps)' },
  { id: 'ext-process-steps', num: '↗', source: 'external', live: true, ext: 'process-steps', route: '/x/process-steps',
    title: 'Numbered Process Steps', author: 'SaaS pattern',
    blurb: 'Connected "how it works" cards that cascade in with a stagger, arrows linking each step.',
    complexity: 'easy', platform: 'any', categories: ['Journey / Timeline', 'Cards / Layout', 'Scroll-driven'],
    library: 'IntersectionObserver stagger' },
  { id: 'ext-zigzag-journey', num: '↗', source: 'external', live: true, ext: 'zigzag-journey', route: '/x/zigzag-journey',
    title: 'Zig-Zag Journey', author: 'Storytelling pattern',
    blurb: 'Alternating image/text rows slide in from opposite sides as you scroll the story.',
    complexity: 'easy', platform: 'any', categories: ['Journey / Timeline', 'Scroll-driven'],
    library: 'IntersectionObserver' },
  { id: 'ext-step-accordion', num: '↗', source: 'external', live: true, ext: 'step-accordion', route: '/x/step-accordion',
    title: 'Vertical Step Accordion', author: 'UI pattern',
    blurb: 'Numbered steps; click one to expand its detail with a smooth max-height slide.',
    complexity: 'easy', platform: 'any', categories: ['Journey / Timeline', 'Cards / Layout'],
    library: 'React state + max-height' },
  { id: 'ext-timeline-dots', num: '↗', source: 'external', live: true, ext: 'timeline-dots', route: '/x/timeline-dots',
    title: 'Animated Dot Timeline', author: 'Codrops pattern',
    blurb: 'Rail dots light up in sequence as you scroll, with a gradient line filling behind them.',
    complexity: 'mod', platform: 'any', categories: ['Journey / Timeline', 'Scroll-driven'],
    library: 'IntersectionObserver + fill' },
  { id: 'ext-roadmap-horizontal', num: '↗', source: 'external', live: true, ext: 'roadmap-horizontal', route: '/x/roadmap-horizontal',
    title: 'Horizontal Roadmap', author: 'Roadmap pattern',
    blurb: 'A sideways-scrolling milestone track; completed nodes glow green, future ones await.',
    complexity: 'mod', platform: 'any', categories: ['Journey / Timeline'],
    library: 'Horizontal scroll + IntersectionObserver' },
  { id: 'ext-progress-rail', num: '↗', source: 'external', live: true, ext: 'progress-rail', route: '/x/progress-rail',
    title: 'Sticky Progress Rail', author: 'Docs / SaaS pattern',
    blurb: 'A pinned left rail whose active step highlights as each section scrolls past.',
    complexity: 'mod', platform: 'desktop', categories: ['Journey / Timeline', 'Scroll-driven'],
    library: 'Sticky rail + IntersectionObserver' },
  { id: 'ext-milestone-counter', num: '↗', source: 'external', live: true, ext: 'milestone-counter', route: '/x/milestone-counter',
    title: 'Milestone Stat Timeline', author: 'Stats pattern',
    blurb: 'A row of milestone nodes whose numbers count up when the strip enters view.',
    complexity: 'easy', platform: 'any', categories: ['Journey / Timeline', 'Text Effect'],
    library: 'IntersectionObserver + rAF count' },

  // ----- Device Mockup -----
  { id: 'ext-browser-window', num: '↗', source: 'external', live: true, ext: 'browser-window', route: '/x/browser-window',
    title: 'Browser Window Mockup', author: 'Mockup pattern',
    blurb: 'A realistic browser chrome framing a product screenshot, floating with a gentle idle tilt.',
    complexity: 'easy', platform: 'any', categories: ['Device Mockup', 'Hero / Header'],
    library: 'Pure CSS chrome + idle float' },
  { id: 'ext-macbook-mockup', num: '↗', source: 'external', live: true, ext: 'macbook-mockup', route: '/x/macbook-mockup',
    title: 'MacBook Mockup', author: 'Mockup pattern',
    blurb: 'A CSS-only laptop frame (lid, hinge, base) showing a dashboard UI — no images.',
    complexity: 'easy', platform: 'any', categories: ['Device Mockup'],
    library: 'Pure CSS laptop frame' },
  { id: 'ext-phone-notch', num: '↗', source: 'external', live: true, ext: 'phone-notch', route: '/x/phone-notch',
    title: 'iPhone Notch Mockup', author: 'Mockup pattern',
    blurb: 'A notched phone frame whose feed auto-scrolls in a seamless loop. Swap in real UI.',
    complexity: 'easy', platform: 'any', categories: ['Device Mockup'],
    library: 'Pure CSS frame + scroll loop' },
  { id: 'ext-dual-device', num: '↗', source: 'external', live: true, ext: 'dual-device', route: '/x/dual-device',
    title: 'Laptop + Phone Combo', author: 'Mockup pattern',
    blurb: 'The classic "works on every screen" shot — a laptop with a phone floating over its corner.',
    complexity: 'easy', platform: 'any', categories: ['Device Mockup', 'Hero / Header'],
    library: 'Pure CSS + idle float' },
  { id: 'ext-tablet-landscape', num: '↗', source: 'external', live: true, ext: 'tablet-landscape', route: '/x/tablet-landscape',
    title: 'Tablet (Landscape) Mockup', author: 'Mockup pattern',
    blurb: 'A wide tablet bezel framing a dashboard that tilts in 3D toward your cursor.',
    complexity: 'mod', platform: 'desktop', categories: ['Device Mockup', 'Motion / Device'],
    library: 'CSS frame + cursor tilt' },
  { id: 'ext-watch-mockup', num: '↗', source: 'external', live: true, ext: 'watch-mockup', route: '/x/watch-mockup',
    title: 'Smartwatch Mockup', author: 'Mockup pattern',
    blurb: 'A rounded-square watch frame with a live-ticking activity ring and time.',
    complexity: 'easy', platform: 'any', categories: ['Device Mockup'],
    library: 'Pure CSS + progress ring' },

  // ----- Motion / Device -----
  { id: 'ext-mouse-parallax-layers', num: '↗', source: 'external', live: true, ext: 'mouse-parallax-layers', route: '/x/mouse-parallax-layers',
    title: 'Mouse Parallax Layers', author: 'Lusion pattern',
    blurb: 'Stacked blurred layers shift by the cursor offset — deeper layers move more for real depth.',
    complexity: 'mod', platform: 'desktop', categories: ['Motion / Device', 'Hero / Header'],
    library: 'Cursor-driven layer offset' },
  { id: 'ext-cursor-trail', num: '↗', source: 'external', live: true, ext: 'cursor-trail', route: '/x/cursor-trail',
    title: 'Cursor Trail', author: 'Codrops pattern',
    blurb: 'A smooth chain of glowing dots that lags behind the cursor with easing.',
    complexity: 'mod', platform: 'desktop', categories: ['Motion / Device', 'Global / Add-anywhere'],
    library: 'requestAnimationFrame trail' },
  { id: 'ext-tilt-stack', num: '↗', source: 'external', live: true, ext: 'tilt-stack', route: '/x/tilt-stack',
    title: '3D Tilt Card Stack', author: 'Aceternity pattern',
    blurb: 'A stack of layered cards tilts toward the cursor, inner layers lifting on the Z axis.',
    complexity: 'mod', platform: 'desktop', categories: ['Motion / Device', 'Cards / Layout'],
    library: 'perspective + rotateX/Y' },
  { id: 'ext-magnetic-dots', num: '↗', source: 'external', live: true, ext: 'magnetic-dots', route: '/x/magnetic-dots',
    title: 'Magnetic Dot Grid', author: 'Interactive pattern',
    blurb: 'A field of dots that push away from the cursor and ease back when it leaves.',
    complexity: 'mod', platform: 'desktop', categories: ['Motion / Device'],
    library: 'rAF magnetic field' },
  { id: 'ext-spotlight-cards', num: '↗', source: 'external', live: true, ext: 'spotlight-cards', route: '/x/spotlight-cards',
    title: 'Spotlight Cards', author: 'Aceternity / Linear pattern',
    blurb: 'A feature grid where a soft spotlight and a glowing border follow the cursor across cards.',
    complexity: 'mod', platform: 'desktop', categories: ['Motion / Device', 'Cards / Layout'],
    library: 'Pointer spotlight + border glow' },

  // ----- Photo / Gallery -----
  { id: 'ext-image-compare', num: '↗', source: 'external', live: true, ext: 'image-compare', route: '/x/image-compare',
    title: 'Before / After Compare', author: 'Common UI pattern',
    blurb: 'Drag the divider to wipe between two images — the top layer is clipped by the slider.',
    complexity: 'easy', platform: 'any', categories: ['Photo / Gallery'],
    library: 'clip-path + range slider' },
  { id: 'ext-polaroid-scatter', num: '↗', source: 'external', live: true, ext: 'polaroid-scatter', route: '/x/polaroid-scatter',
    title: 'Scattered Polaroids', author: 'Awwwards pattern',
    blurb: 'Photo cards tossed at random angles; hover one to straighten, lift, and bring it forward.',
    complexity: 'easy', platform: 'any', categories: ['Photo / Gallery', 'Cards / Layout'],
    library: 'CSS transforms' },
  { id: 'ext-hover-zoom-grid', num: '↗', source: 'external', live: true, ext: 'hover-zoom-grid', route: '/x/hover-zoom-grid',
    title: 'Hover Zoom Gallery', author: 'Gallery pattern',
    blurb: 'A tight grid where hovering a tile zooms its image inside the frame and fades in a caption.',
    complexity: 'easy', platform: 'any', categories: ['Photo / Gallery'],
    library: 'CSS overflow + scale' },
  { id: 'ext-lightbox-grid', num: '↗', source: 'external', live: true, ext: 'lightbox-grid', route: '/x/lightbox-grid',
    title: 'Lightbox Grid', author: 'Gallery pattern',
    blurb: 'Click any thumbnail to expand it into a centered overlay with a dimmed backdrop (Esc to close).',
    complexity: 'easy', platform: 'any', categories: ['Photo / Gallery'],
    library: 'React state overlay' },
  { id: 'ext-filmstrip-marquee', num: '↗', source: 'external', live: true, ext: 'filmstrip-marquee', route: '/x/filmstrip-marquee',
    title: 'Filmstrip Marquee', author: 'Magic UI pattern',
    blurb: 'A seamless auto-scrolling row of gallery cards that pauses on hover. Zero dependencies.',
    complexity: 'easy', platform: 'any', categories: ['Photo / Gallery', 'Global / Add-anywhere'],
    library: 'Duplicated track + translateX' },
  { id: 'ext-focus-row', num: '↗', source: 'external', live: true, ext: 'focus-row', route: '/x/focus-row',
    title: 'Expanding Focus Row', author: 'Codrops pattern',
    blurb: 'A row of panels where hovering one expands its width and reveals a caption as the rest shrink.',
    complexity: 'mod', platform: 'any', categories: ['Photo / Gallery', 'Cards / Layout'],
    library: 'Flex-grow transition' },
)
